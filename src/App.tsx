  ...
  return (
    <div className="flex h-auto min-h-screen justify-center bg-white px-7 pb-7 text-neutral-900 dark:bg-black dark:text-neutral-300 sm:px-10 sm:pb-10">
      <div className="flex w-full flex-col">
        <div className="flex justify-end space-x-2 pt-2 text-xs dark:font-thin lg:text-sm">
        ...
        <div className="sticky top-0 flex justify-between bg-white pb-1 pt-1 dark:bg-black lg:h-9">
          ...
          <button
            className={
              'h-7 border-2 px-1 font-medium dark:bg-neutral-900 ' +
              (resetBtnClicked
                ? 'w-20 border-blue-500 bg-blue-50 text-blue-500 hover:border-blue-700 active:bg-blue-100 dark:border-blue-800 dark:text-blue-700 dark:hover:border-blue-700 dark:active:bg-blue-950'
