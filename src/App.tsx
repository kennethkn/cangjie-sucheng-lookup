  ...
  return (
    <div className="flex h-auto min-h-screen flex-col bg-white px-7 pb-7 text-neutral-900 sm:px-10 sm:pb-10 dark:bg-black dark:text-neutral-300">
      ...
      <div className="flex justify-between bg-white pb-1 pt-1 lg:h-9 dark:bg-black">
        ...
        <button
          className={
            'h-7 border-2 px-2 font-bold dark:bg-neutral-900 ' +
            (resetBtnClicked
              ? 'w-24 border-blue-500 bg-blue-50 text-blue-500 hover:border-blue-700 active:bg-blue-100 dark:border-blue-700 dark:text-blue-600 dark:hover:border-blue-600 dark:active:bg-blue-950'
